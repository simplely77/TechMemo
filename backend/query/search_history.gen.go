...
func newSearchHistory(db *gorm.DB, opts ...gen.DOOption) searchHistory {
	...
	_searchHistory.SearchType = field.NewString(tableName, "search_type")
	...
	_searchHistory.TargetType = field.NewString(tableName, "target_type")
...
func (s *searchHistory) updateTableName(table string) *searchHistory {
	...
	s.SearchType = field.NewString(table, "search_type")
	s.LastSearchedAt = field.NewTime(table, "last_searched_at")
	s.CreatedAt = field.NewTime(table, "created_at")
	s.TargetType = field.NewString(table, "target_type")
...
func (s *searchHistory) fillFieldMap() {
	...
	s.fieldMap["search_type"] = s.SearchType
	s.fieldMap["last_searched_at"] = s.LastSearchedAt
	s.fieldMap["created_at"] = s.CreatedAt
	s.fieldMap["target_type"] = s.TargetType
}
